...
print(dir(i3.get_tree()))
pprint(i3.get_tree().leaves())
...
def on_workspace_focus(self, e):
    # The first parameter is the connection to the ipc and the second is an 
    # object with the data of the event sent from i3.
    if e.current:
